...
import com.techzen.academy_n0325c1.dto.authenticate.IntrospectResponse;
...
public interface IAuthenticateService {
    ...
    IntrospectResponse introspect(IntrospectRequest introspectRequest) throws AppException, ParseException, JOSEException;
