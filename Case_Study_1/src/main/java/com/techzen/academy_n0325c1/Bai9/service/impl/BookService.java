...
public class BookService implements IBookService {
    ...
    @Override
    public Page<Book> findByAttr(String title, String author, Integer totalCopies, Pageable pageable) {
        return bookRepository.findByAttr(title, author, totalCopies, pageable);
    }
